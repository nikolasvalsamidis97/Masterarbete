...
OUTPUT_PATH = pathlib.Path(__file__).resolve().parents[2] / "Plots" / "Photon pressure" / "F_ph_vs_Ncol.pdf"
SPECTRUM_PATH = PROJECT_ROOT / "TS" / "Spectral_type" / "A" / "A6" / "lte080-4.0-0.0a+0.0.BT-NextGen.7.dat.txt"
TITLE_SIZE = 17
AXIS_LABEL_SIZE = 18
TICK_LABEL_SIZE = 15
LEGEND_SIZE = 12
