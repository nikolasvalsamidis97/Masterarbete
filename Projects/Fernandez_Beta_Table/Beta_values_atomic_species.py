...
beta_pic = Star('Templates/TS/models_1770121505/bt-nextgen-agss2009/lte080-4.0-0.0a+0.0.BT-NextGen.7.dat.txt', 
...
outpath = pathlib.Path(__file__).resolve().parent / "results" / "Tables" / "beta_thiswork_my_model.csv"
