...
RUNTIME_CACHE_DIR = pathlib.Path(__file__).resolve().parent / "results" / "Tables" / "runtime_cache" / "test_for_whole_pipeline"
...
OUTPUT_FILE = OUTPUT_DIR / "test_for_whole_pipeline_results.txt"
SWEEP_OUTPUT_FILE = OUTPUT_DIR / "test_for_whole_pipeline_temperature_sweep.txt"
