...
a5v_130 = Star('Templates/TS/Beta pic Spectra/HRspec_A5V_130.dat',
               1.75*const.R_sun, 1.75*const.M_sun, vsini, epsilon)

alpha = (5.24)*1e-5 
dist_for_paper = 1 * const.au
a5v_130.convert_from_log10(alpha, dist_for_paper)


pps_obj = {sp: PhotonPressure(broad_prof, a5v_130) for sp, broad_prof in broadening_profiles.items()}
Temp_atm = [1] *u.K
Ncol = [0] * u.cm**(-2)
