...
OUTPUT_PATH = pathlib.Path(__file__).resolve().parent / "results" / "Plots" / "Broadening plots" / "RotBroadPlot.pdf"
# Closest local replacement for the older unavailable 5700 K BT-NextGen file.
SPECTRUM_PATH = PROJECT_ROOT / "Templates" / "TS" / "Spectral_type" / "F" / "F4" / "lte066-4.0-0.0a+0.2.BT-NextGen.7.dat.txt"
AXIS_LABEL_SIZE = 15
TICK_LABEL_SIZE = 13
Y_SCALE = 1e7
