...
OUTPUT_DIR = pathlib.Path(__file__).resolve().parent / "results" / "Tables" / "Beta_vs_temp"
...
stellar_models = {
  "B4": {"Teff": 19000 * u.K, "path": "Templates/TS/Spectral_type/B/B4/lte170-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 4.3 * const.R_sun, "mass": 7.0 * const.M_sun, "vsini": 80 * u.km/u.s, "epsilon": 0.4 * u.dimensionless_unscaled},
  "B5": {"Teff": 17000 * u.K, "path": "Templates/TS/Spectral_type/B/B5/lte150-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 4.1 * const.R_sun, "mass": 6.0 * const.M_sun, "vsini": 80 * u.km/u.s, "epsilon": 0.4 * u.dimensionless_unscaled},
  "B7": {"Teff": 13000 * u.K, "path": "Templates/TS/Spectral_type/B/B7/lte130-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 3.7 * const.R_sun, "mass": 5.0 * const.M_sun, "vsini": 80 * u.km/u.s, "epsilon": 0.4 * u.dimensionless_unscaled},
  "A0": {"Teff": 10000 * u.K, "path": "Templates/TS/Spectral_type/A/A0/lte100-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 2.5 * const.R_sun, "mass": 2.5 * const.M_sun, "vsini": 120 * u.km/u.s, "epsilon": 0.5 * u.dimensionless_unscaled},
  "A6": {"Teff": 8000 * u.K, "path": "Templates/TS/Spectral_type/A/A6/lte080-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 1.85 * const.R_sun, "mass": 1.95 * const.M_sun, "vsini": 120 * u.km/u.s, "epsilon": 0.5 * u.dimensionless_unscaled},
  "F8": {"Teff": 6000 * u.K, "path": "Templates/TS/Spectral_type/F/F8/lte060-4.0-0.0a+0.2.BT-NextGen.7.dat.txt", "radius": 1.25 * const.R_sun, "mass": 1.25 * const.M_sun, "vsini": 20 * u.km/u.s, "epsilon": 0.6 * u.dimensionless_unscaled},
  "K1": {"Teff": 5000 * u.K, "path": "Templates/TS/Spectral_type/K/K1/lte050-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 0.82 * const.R_sun, "mass": 0.82 * const.M_sun, "vsini": 3 * u.km/u.s, "epsilon": 0.6 * u.dimensionless_unscaled},
  "K5": {"Teff": 4500 * u.K, "path": "Templates/TS/Spectral_type/K/K5/lte044-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 0.70 * const.R_sun, "mass": 0.70 * const.M_sun, "vsini": 3 * u.km/u.s, "epsilon": 0.6 * u.dimensionless_unscaled},
  "K7": {"Teff": 4000 * u.K, "path": "Templates/TS/Spectral_type/K/K7/lte040-4.0-0.0a+0.0.BT-NextGen.7.dat.txt", "radius": 0.65 * const.R_sun, "mass": 0.65 * const.M_sun, "vsini": 3 * u.km/u.s, "epsilon": 0.6 * u.dimensionless_unscaled},
}
...
beta_csv_path = OUTPUT_DIR / "Beta_vs_Teff.csv"
beta_df_csv.to_csv(beta_csv_path, index=False)
print(f"Saved beta table to {beta_csv_path}")
...
beta_tex_path = OUTPUT_DIR / "Beta_vs_Teff.tex"
with open(beta_tex_path, "w", encoding="utf-8") as f:
  f.write(latex_table)
print(f"Saved LaTeX beta table to {beta_tex_path}")
...
stars_csv_path = OUTPUT_DIR / "Stars_used.csv"
stars_df.to_csv(stars_csv_path, index=False)
print(f"Saved stars table to {stars_csv_path}")

stars_latex = stars_df.to_latex(index=False, escape=False, longtable=True)
stars_tex_path = OUTPUT_DIR / "Stars_used.tex"
with open(stars_tex_path, "w", encoding="utf-8") as f:
  f.write(stars_latex)
print(f"Saved LaTeX stars table to {stars_tex_path}")
