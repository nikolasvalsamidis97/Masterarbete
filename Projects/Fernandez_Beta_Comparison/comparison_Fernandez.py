...
PLOTS_ROOT = pathlib.Path(__file__).resolve().parent / "results" / "Plots"
SHOW_FIGURE = False
BT_NEXTGEN_PATH = PROJECT_ROOT / "Templates" / "TS" / "Spectral_type" / "A" / "A6" / "lte080-4.0-0.0a+0.0.BT-NextGen.7.dat.txt"
FERNANDEZ_PATH = PROJECT_ROOT / "Templates" / "TS" / "Beta pic Spectra" / "HRspec_A5V_130.dat"
